...
-(UIButton *)createCustomButton{    
    UIImage *buttonImage=[UIImage imageNamed:@"camera_button_take のコピー .png"];
    UIImage *buttonHigihlightimage=[UIImage imageNamed:@"tabBar_cameraButton_ready_matte のコピー .png"];
...
-(void)tabBarController:(UITabBarController *)tabBarController didSelectViewController:(UIViewController *)viewController{
    ...
    if(viewController==_cameraController){
        NSLog(@"check");
        [cameraButton setBackgroundImage:[UIImage imageNamed:@"tabBar_cameraButton_ready_matte のコピー .png"] forState:UIControlStateNormal];
    }else{
        [cameraButton setBackgroundImage:[UIImage imageNamed:@"camera_button_take のコピー .png"] forState:UIControlStateNormal];
    }
}
