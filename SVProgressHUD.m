...
@property (nonatomic, strong) CAShapeLayer *_backgroundRingLayer;
@property (nonatomic, strong) CAShapeLayer *_ringLayer;
...
@synthesize overlayWindow, hudView, maskType, fadeOutTimer, stringLabel, imageView, spinnerView, visibleKeyboardHeight ,_ringLayer,_backgroundRingLayer, progress;
